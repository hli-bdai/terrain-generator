...
if __name__ =="__main__":
    ...
    parser.add_argument(
        "--obj_path", type=str, default="results/generated_terrain", help="Path to the obj file"
    )
    parser.add_argument(
        "--stl_path", type=str, default="results/generated_terrain/terrains", help="Path to the exported stl file"
    )
